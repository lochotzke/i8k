...
static int fan_max = I8K_FAN_MAX;
...
static struct dmi_system_id i8k_dmi_table[] __initdata = {
	...
	},
	{
		...
		.matches = {
			DMI_MATCH(DMI_SYS_VENDOR, "Dell Inc."),
			DMI_MATCH(DMI_PRODUCT_NAME, "Precision WorkStation 490"),
		},
